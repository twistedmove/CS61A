...
def make_average(fn, num_samples=40000):
...
def make_mean_strategy(min_points, num_rolls=5):
    ...
    def mean_strategy(my_score, op_score):
        free_bacon_score = op_score // 10 + 1
...
def final_strategy(score, opponent_score):
    ...
    if True:
        if score - opponent_score > 15:
            ...
            return make_comeback_strategy(10,5)(score, opponent_score) #10, 5: 0.61865
    ...
    return 3 # normally 5 gives the highest expectation of income score
